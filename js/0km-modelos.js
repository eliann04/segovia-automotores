...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (!selectedBrand) { window.location.href = '0km.html'; return; }
    ...
    const BRAND_LOGOS = {
        ...
        'citroën': 'img/citroen.png', 'citroen': 'img/citroen.png',
        'jeep': 'img/jeep.png',
    };
    ...
    function showError() {
        ...
        noResultsMsg.innerHTML = `
            ...
            <a href="0km.html" class="btn btn-outline" style="margin-top:1rem;">Volver a Marcas</a>`;
    }
